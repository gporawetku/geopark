...
<div class="row">
    <div class="col-md-8">
        <div class="card">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @can('update', $blog)
                                <a href="{{ route('blogs.index', ['action' => 'edit', 'id' => $blog->id] + Request::only('page', 'q')) }}" id="edit-blog-{{ $blog->id }}">{{ __('app.edit') }}</a>
                            @endcan
                        </td>
                    </tr>
                    @endforeach
            ...
            <div class="card-body">{{ $blogs->appends(Request::except('page'))->render() }}</div>
        </div>
    </div>
    <div class="col-md-4">
